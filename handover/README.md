...
3. `workflow_issue.md`（レビュー駆動ワークフロー — `issue_open.md` があれば最優先）
...
- [イシュー駆動ワークフロー](workflow_issue.md)
  - Method A/B/C 共通: `docs/issues/` のイシュー指摘への優先対応手順。`issue_open.md` の有無で判定。
...
> レビュー記録は `docs/issues/` に集約。[docs/issues/README.md](../docs/issues/README.md) も参照。
...
- [next_session/prompt_pack_finish.md](next_session/prompt_pack_finish.md)
  - セッション終了用プロンプト群（必須）。
- [next_session/prompt_pack_issue.md](next_session/prompt_pack_issue.md)
