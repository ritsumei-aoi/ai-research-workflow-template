...
- [workflow_method_c.md](workflow_method_c.md)（Method C: GitHub Agentic ワークフロー）**[ドラフト]**
...
| **Git ワークフロー** | `ai/<date>-<topic>` → スカッシュマージ | `ai/<date>-<topic>` → スカッシュマージ | `agentic/<issue>-<topic>` → スカッシュマージ |
| **ツール要件** | ブラウザ / チャット UI | Copilot CLI / Gemini CLI 等 | GitHub Agentic ワークフロー |
...
<!-- CUSTOMIZE: プロジェクト固有のタスク例を各方式に追加してください。 -->
<!-- 以下は汎用的な例です。プロジェクトの実際のタスクに置き換えてください。 -->
