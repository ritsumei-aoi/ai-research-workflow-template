...
<!-- CUSTOMIZE: プロジェクトの参照論文・リソースに置き換えてください -->

```markdown
## 1. 論文と作業の概要

### 対象論文
<!-- CUSTOMIZE: 参照論文やリソースを記述してください -->
添付されている **`<reference-file>`** が、このセッションの作業の中心です。

### プロジェクトの目的
<!-- CUSTOMIZE: プロジェクトの目的を記述してください -->
...
**確認項目**:
- **現在の状態（最新状況）**: 最終更新日と進行状況の要約
- **実装ロードマップ**: 完了済み・未完了のステップ
...
- **引き継ぎメモルール**: latest/archived の分割構造、更新タイミング、テンプレート構造
- **セッション終了チェックリスト**: セッション終了時の確認事項
