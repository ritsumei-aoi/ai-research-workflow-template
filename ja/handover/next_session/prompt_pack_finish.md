...
2. 今回のセッション内容を反映する
   - セッション目標: `handover_memo_latest.md` の「🔄 次回セッションへの引き継ぎ」から転記
   - 追加コンテキスト: 今回作成したログファイル `log/YYYY-MM-DD-<topic>.md` を追加
   - メタデータ: 作成日時と前回ログへのリンク
